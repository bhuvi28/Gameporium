      ...
      <div class="navbar">
        <div class="row">
          <div class="columnLogo">
            <a href="homePage.html"><img class="logoStyles" src="logo.png" alt="gameporiumLogo" /></a>
          </div>
          <div class="columnNavbar">
            <a href="homePage.html" style="text-decoration: none;"><img
              title="Home"
              width="60px"
        ...
        <div class="columnLeftNavBar">
          <div class="leftNavContainer">
            <ul style="padding: 0px">
              <a class="navbarItems" href="Quiz.html"><li>Quiz</li></a>
              <a class="navbarItems" href="subscriptionPlans.html"><li>Subscription Plans</li></a>
              <a class="navbarItems" href="userLibrary.html"><li>Library</li></a>
              <a class="navbarItems" href="#"><li>News & Trending</li></a>
              <a class="navbarItems" href="#"><li>Bestsellers</li></a>
              <a class="navbarItems" href="storePage.html"><li>Store</li></a>
              <a class="navbarItems" href="ContactUs.html"><li>Contact Us</li></a>
            </ul>
          </div>
        </div>
        <div class="columnPictureSlide">
          <div class="slideshow-container">
            <div>
              ...
              />
              <div class="overlay">GO TO STORE PAGE</div>
            </div>
          ...
          <div class="row">
            <div class="col-1">
              <div class="gameList">
                ...
                <div class="overlayImagesBelow">GO TO STORE PAGE</div>
              </div>
            </div>
            <div class="col-2">
              <div class="gameList">
